(function (modules) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _Canvas2 = requireDefault(_Canvas)
        var _document2 = __webpack_require__(10)
        var _document3 = requireDefault(_document2)
        var _navigator2 = __webpack_require__(17)
        var _navigator3 = requireDefault(_navigator2)
        var _XMLHttpRequest2 = __webpack_require__(18)
        var _XMLHttpRequest3 = requireDefault(_XMLHttpRequest2)
        var _WebSocket2 = __webpack_require__(19)
        var _WebSocket3 = requireDefault(_WebSocket2)
        var _Image2 = __webpack_require__(11)
        var _Image3 = requireDefault(_Image2)
        var _Audio2 = __webpack_require__(12)
        var _Audio3 = requireDefault(_Audio2)
        var _FileReader2 = __webpack_require__(20)
        var _FileReader3 = requireDefault(_FileReader2)
        var _HTMLElement2 = __webpack_require__(4)
        var _HTMLElement3 = requireDefault(_HTMLElement2)
        var _localStorage2 = __webpack_require__(21)
        var _localStorage3 = requireDefault(_localStorage2)
        var _location2 = __webpack_require__(22)
        var _location3 = requireDefault(_location2)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _HTMLElement4 = requireDefault(_HTMLElement3)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _Element3 = requireDefault(_Element2)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _Node3 = requireDefault(_Node2)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _EventTarget3 = requireDefault(_EventTarget2)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _HTMLElement2 = requireDefault(_HTMLElement)
        var _document = __webpack_require__(10)
        var _document2 = requireDefault(_document)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var window = requireWildcard(_window)
        var _HTMLElement = __webpack_require__(4)
        var _HTMLElement2 = requireDefault(_HTMLElement)
        var _Image = __webpack_require__(11)
        var _Image2 = requireDefault(_Image)
        var _Audio = __webpack_require__(12)
        var _Audio2 = requireDefault(_Audio)
        var _Canvas = __webpack_require__(9)
        var _Canvas2 = requireDefault(_Canvas)
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _HTMLAudioElement3 = requireDefault(_HTMLAudioElement2)
        ...
        var Audio = function (_HTMLAudioElement) {
            ...
            function Audio(url) {
                ...
                if (!innerAudioContext.onPause) {
                    innerAudioContext.onPause = function (callback) {
                        callback()
                    }
                }
                if (!innerAudioContext.onEnded) {
                    innerAudioContext.onEnded = function (callback) {
                        callback()
                    }
                }
                if (!innerAudioContext.onError) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _HTMLMediaElement3 = requireDefault(_HTMLMediaElement2)
